...
slash : slash.o internal_commands.o signal.o redirection.o external_commands.o wildcard.o
	$(CC) -o slash slash.o internal_commands.o signal.o redirection.o external_commands.o wildcard.o $(LDLIBS) -Ilibrary
